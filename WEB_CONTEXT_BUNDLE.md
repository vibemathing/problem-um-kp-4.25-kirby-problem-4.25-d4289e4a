...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.25-kirby-problem-4.25-d4289e4a-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.25"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.25-kirby-problem-4.25-d4289e4a-v1",
      "problem_contract_sha256": "cd4531281e72fa186e757990564f532ed06ec34703d54f3eff7aa272ea8e1a5a",
      "problem_id": "problem:um-kp-4.25-kirby-problem-4.25-d4289e4a",
      "route_id": "route:um-kp-4.25-kirby-problem-4.25-d4289e4a-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.25-kirby-problem-4.25-d4289e4a-source-fidelity-01",
      "graph_id": "graph:um-kp-4.25-kirby-problem-4.25-d4289e4a-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.25-kirby-problem-4.25-d4289e4a-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.25-kirby-problem-4.25-d4289e4a-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Under what conditions does a closed, orientable 3-manifold M smoothly embed in $S^{4}$? Is this question algorithmically decidable?"
          },
          "statement_sha256": "cc9af2381f8ea7a41ff0524a314e6bf014a2e4b51a3070922560623d2934394d"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.25-kirby-problem-4.25-d4289e4a-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.25-kirby-problem-4.25-d4289e4a-root",
      "route_id": "route:um-kp-4.25-kirby-problem-4.25-d4289e4a-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.25-f811b3b26c2b",
        "url": "https://www.unsolvedmath.com/problems/KP-4.25"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
